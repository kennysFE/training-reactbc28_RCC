...
export default class LayoutFilm extends Component {
      ...
      return <div className='col-lg-2 col-md-3 mt-2' key={index}>
        <div className='card'>
          ...
          <div className='card-body bg-dark text-white'>
            <h3 style={{height: 75}}>{film.tenPhim}</h3>
            <p style={{height: 75}}>{film.moTa.length >100 ? film.moTa.slice(0, 100) + "..." : film.mo}</p>
          </div>
        </div>
      </div>
    })
  ...
  render() {
    return (
      <div className='bg-film'>
        <div className='h-100' style={{background:'rgba(0,0,0,0.5}', minHeight: '100%'}}>
          <nav className="navbar navbar-expand-sm navbar-dark " style = {{background: 'rgba(255,0,255,0.7' }}>
